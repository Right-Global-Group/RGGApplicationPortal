    ...
    public function edit(Account $account): Response
    {
        ...
        return Inertia::render('Accounts/Edit', [
            ...
            'applications' => $applications->map(fn ($app) => [
                ...
                : false,
                'cashflows_docusign_envelope_id' => $app->status->cashflows_docusign_envelope_id ?? null,
                'status' => $app->status ? [
                    ...
                    'timestamps' => [
                        ...
                        'cashflows_switch_notice_sent' => $app->status->cashflows_switch_notice_sent_at?->format('Y-m-d H:i'),
