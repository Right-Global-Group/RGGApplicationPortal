...
<head>
    ...
    <title>New Application Message</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #cbd5e1;">
                                Hello <strong style="color: #f0abfc;">{{ $recipient_name }}</strong>,
                            </p>

                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 1.6; color: #cbd5e1;">
                                <strong style="color: #e2e8f0;">{{ $sender_name }}</strong> has posted a message on application: <strong style="color: #e2e8f0;">{{ $application_name }}</strong>
                            </p>
                            ...
                            <p style="margin: 25px 0 20px 0; font-size: 16px; line-height: 1.6; color: #cbd5e1;">
                                You can view the full conversation and reply using the button below.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $thread_url }}" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #f0abfc 0%, #e879f9 100%); color: #1e293b; text-decoration: none; border-radius: 10px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(240, 171, 252, 0.3);">
                                            View Conversation
                                        </a>
                                    </td>
                                </tr>
