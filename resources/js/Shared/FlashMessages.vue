<template>
  <div>
    <div v-if="$page.props.flash.success && show" class="flex items-center justify-between mb-8 w-full bg-blue-900/80 rounded">
    ...
    <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" class="flex items-center justify-between mb-8 w-full bg-red-900/80 rounded">
      <div class="flex items-center">
