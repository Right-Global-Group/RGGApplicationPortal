<template>
  <div>
    <Head title="Contacts" />
    <h1 class="mb-4 text-3xl font-bold text-white">Contacts</h1>
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <Link class="btn-primary flex items-center gap-2" href="/contacts/create">
        <span>Create</span>
          ...
          >
            ...
            <td class="border-t border-primary-800/20">
              <Link
                ...
                tabindex="-1"
              >
                {{ contact.application ? contact.application.name : '-' }}
              </Link>
            </td>
            <td class="border-t border-primary-800/20">
              <Link
